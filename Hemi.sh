...
generate_key() {
    ...
    URL="https://github.com/hemilabs/heminetwork/releases/download/v0.10.0/heminetwork_v0.10.0_linux_amd64.tar.gz"
    FILENAME="heminetwork_v0.10.0_linux_amd64.tar.gz"
    DIRECTORY="/root/heminetwork_v0.10.0_linux_amd64"
...
# 运行节点函数
run_node() {
    DIRECTORY="$HOME/heminetwork_v0.10.0_linux_amd64"
...
# 查看日志函数
view_logs() {
    DIRECTORY="heminetwork_v0.10.0_linux_amd64"
